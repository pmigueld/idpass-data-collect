...
interface FingerOption {
  label: string
  value: string
}

export class BiometricCapture extends Field {
  static schema(...extend: any[]): any {
    ...
    // Use apply to handle the spread properly
    return (Field.schema as any).apply(Field, [baseSchema, ...extend])
  }
  ...
  static editForm() {
    const fingerOptions: FingerOption[] = [
...
export function registerBiometricComponent() {
