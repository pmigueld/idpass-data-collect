...
interface FormioWithComponents {
  Components?: {
...
/**
 * Register custom Form.io components for the admin form builder.
 * This should be called before rendering any Form.io builder instances.
 */
